<template>
  <div class="page-container p-6">
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
        <h1 class="text-3xl font-bold text-white font-display">{{ authStore.isAdmin ? 'Gestión de Equipos' : 'Equipos de la Liga' }}</h1>
        <p class="text-obsidian-400 mt-1">{{ authStore.isAdmin ? 'Administra lo clubes y delegados de la liga.' : 'Conoce a los clubes que participan en el torneo.' }}</p>
      </div>

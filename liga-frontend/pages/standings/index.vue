    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-3">
        <select
          ...
          class="bg-surface/80 border border-border rounded-xl px-4 py-2.5 text-content focus:outline-none focus:border-primary transition-all text-sm font-medium min-w-[220px]"
        >
